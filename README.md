...
Grab a release binary from our [releases page](https://github.com/littlstar/supr/releases).

To install via npm, simply run `npm i littlstar/supr -g`.
...
Commands:
  ...
  launch [options]                 Launch a Suprnova pool
  ls [options] [path]              List the contents of a CFS
  join <swarm_key>                 Join a Suprnova pool
  ...
  send <discovery_key>             Send your work CFS to a Suprnova pool
```
